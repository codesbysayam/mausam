...
export const translations: Record<Language, Partial<TranslationDictionary>> = {
  en: {
    ...
    allRightsReserved: '© 2026 MAUSAM National Meteorological Platform • India Meteorological Department',
  ...
  hi: {
    ...
    allRightsReserved: '© 2026 मौसम राष्ट्रीय मौसम मंच • भारतीय मौसम विभाग',
  ...
  or: {
    ...
    allRightsReserved: '© ୨୦୨୬ ମୌସମ ଜାତୀୟ ପାଣିପାଗ ମଞ୍ଚ • ଭାରତୀୟ ପାଣିପାଗ ବିଭାଗ',
